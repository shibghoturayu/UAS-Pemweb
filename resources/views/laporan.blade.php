          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="{{ url('/dataiklan') }}l">Data Iklan</a></li>
              </ul>
            </li>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            ...
            <a href="{{ url('/tambahiklan') }}" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> Cetak Laporan</a>
