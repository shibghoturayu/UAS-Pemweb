...
<!--page title section-->
<section class="inner_cover parallax-window" data-parallax="scroll" data-image-src="assets/img/auditorium.jpg">
    ...
    <div class="container">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li><span style="color: #35076e">SEMINAR & WORKSHOP</span></li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="col-md-2 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    ...
                    <div class="info_box">
                        <h4 class="name">
                        <a href="/event"><strong>Health & Beauty</strong></a>
                        </h4>
                    </div>
                </div>
            </div>
