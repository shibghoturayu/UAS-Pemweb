    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse flex-sm-row-reverse" id="headernav">
            <ul class=" nav navbar-nav menu">
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(url('/index')); ?>">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active text-white" href="<?php echo e(route('login')); ?>">
                            Login
                        </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active text-white" href="<?php echo e(route('register')); ?>">
                            Register
                        </a>
                </li>
...
</html><?php /**PATH C:\xampp\htdocs\event\resources\views/home1.blade.php ENDPATH**/ ?>