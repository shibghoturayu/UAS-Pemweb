          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
              	<li><a class="nav-link" href="<?php echo e(url('/dataadmin')); ?>">Data Admin</a></li>
                <li><a class="nav-link" href="<?php echo e(url('/datatransaksi')); ?>">Data Transaksi</a></li>
                <li><a class="nav-link" href="<?php echo e(url('/dataiklan')); ?>l">Data Iklan</a></li>
              </ul>
            </li>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            ...
            <a href="<?php echo e(url('/tambahiklan')); ?>" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> Cetak Laporan</a>
                      ...
                      <form>
                        ...
                        <div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button class="btn btn-primary"><i class="fas fa-search">Cetak</i></button>
                          </div>
                        </div>
                      </form>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\event\resources\views/laporan.blade.php ENDPATH**/ ?>