      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Data Iklan</h2>
            <p class="section-lead">Mengelola Data Iklan</p>
            <a href="<?php echo e(url('/tambahiklan')); ?>" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> Tambah Data Iklan</a>
                      ...
                      <table class="table table-striped" id="sortable-table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>2020-05-20</td>
                            <td>Cleo</td>
                            <td>PT. Cleo Indonesia</td>
                            
                            
                            <td><div class="badge badge-success">Posted</div></td>
                           ...
                           <tr>
                            ...
                            <td>2020-05-21</td>
                            <td>Gramedia Store</td>
                            <td>Gramedia Indonesia</td>
                            
                            
                            <td><div class="badge badge-danger">Unposted</div></td>
                            <td><a href="#" class="btn btn-info">Detail</a></td>
                          </tr>
...
</html><?php /**PATH C:\xampp\htdocs\event\resources\views/dataiklan.blade.php ENDPATH**/ ?>